...
export default function CustomerOrderReport() {
  ...
  const totalSpent = filteredOrders.reduce((s, o) => s + o.totalAmount, 0);
  ...
  return (
    <div className="rpt-page">
      ...
      <div ref={ref}>
        <RptHeader title="Order & Payment Report" meta={`Customer: ${user.name} · Status: ${statusFilter} · Payment: ${paymentFilter} · Date: ${getDateRangeLabel(fromDate, toDate)}`}/>
